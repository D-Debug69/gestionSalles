...
class villeController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            'salles.*.prix_matin' => 'nullable|numeric|min:0',
            'salles.*.prix_apres_midi' => 'nullable|numeric|min:0',
            'salles.*.prix_journee' => 'nullable|numeric|min:0',
           ...
           foreach ($request->salles as $index => $salleData) {
            $salleImagePath = null;
                ...
                Salle::create([
                    ...
                    'prix_matin' => $salleData['prix_matin'] ?? null,
                    'prix_apres_midi' => $salleData['prix_apres_midi'] ?? null,
                    'prix_journee' => $salleData['prix_journee'] ?? null,
                    'ville_id' => $ville->id,
